...
class GradientExplainer(InnvestigateExplainer):
  ...
  def __init__(self, model):
    super(GradientExplainer, self).__init__(model, explanation_method="gradient")
  
  def GradientAttributionToImage(self, gradient_attribution):
    return super(GradientExplainer, self).InnvestigateAttributionToImage(gradient_attribution)

  def GenerateGradientExplanationImage(self,input_image,explanation_values):
      return super(GradientExplainer, self).GenerateInnvestigateExplanationImage(input_image,explanation_values)
